...
# Aliases for starting and stopping Hadoop
alias Start_HADOOP="$HADOOP_HOME/sbin/start-dfs.sh && $HADOOP_HOME/sbin/start-yarn.sh && $HADOOP_HOME/bin/mapred --daemon start historyserver"
alias Stop_HADOOP="$HADOOP_HOME/bin/mapred --daemon stop historyserver && $HADOOP_HOME/sbin/stop-yarn.sh && $HADOOP_HOME/sbin/stop-dfs.sh"
